      ...
      <div className="icon_box">
        <div className="theme_btn ">
          <button className="icon_btn">
            ...
            <svg className="sunIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
            ...
            {/* Moon */}
            <svg className="active moonIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
        ...
        <div className="user_avatar icon_btn">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
